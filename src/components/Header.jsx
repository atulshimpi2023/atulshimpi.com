      ...
      <nav className="primary-menu navbar navbar-expand-lg navbar-dark bg-dark border-bottom-0">
        <div className="container-fluid position-relative h-100 flex-lg-column ps-3 px-lg-3 pt-lg-3 pb-lg-2">
          ...
          >
            ...
            <h1 className="text-5 text-white text-sm-left text-md-center text-lg-center text-xl-center mb-0 d-lg-block ">
              Atul Shimpi
            </h1>
            <h2 className="text-2 text-sm-left text-md-center text-lg-center text-xl-center mb-0 d-lg-block" style={{color: "grey", 'paddingTop': "3px" }}>Frontend Expert</h2>
          </Link>
          {/* Logo End */}
          <div
            id="header-nav"
